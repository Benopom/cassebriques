...
for (let i = 0; i < nbRow; i++) {
    ...
    for(let j = 0; j < nbCol; j++){
        ...
        brique[i][j] = {x:0, y: 0, statut:1} //on définit chaque élément du tableau comme un objet
    }
}
...
function mouvementSouris (e){
    ...
    // canvas.offsetLeft 
    //console.log(posXBarreCanvas); donne la position X de la souris par rapport au canvas
